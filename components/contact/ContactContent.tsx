        ...
        <div className="contact-grid">
          {activeTab === 'produsen' ? (
            <div className="contact-card">
              ...
              <div className="row"><b>Kode Pos</b><span>15210</span></div>
            ...
            <div className="contact-card">
              ...
              <div className="row"><b>Kode Pos</b><span>473000</span></div>
          ...
          {activeTab === 'produsen' && (
            <>
              <div className="contact-map" style={{ position: 'relative', minHeight: '320px', overflow: 'hidden' }}>
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.8156!2d106.70746553688838!3d-6.068785820783269!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f6d4d4d4d4d%3A0x1f1f1f1f1f1f1f1f!2sGinnva%20Indonesia!5e0!3m2!1sid!2sid!4v1718912345678!5m2!1sid!2sid"
                  width="100%"
                  height="100%"
              ...
              <div style={{ marginTop: '12px', textAlign: 'center' }}>
                <a 
                  href="https://maps.app.goo.gl/GWdRAxh8ZReup8hj9" 
                  target="_blank" 
