...
export default function FilmKacaBangunanPage() {
  return (
    <main data-page="product" data-nav="product">
      <ProductBanner currentId="4" title="Film Kaca Bangunan" enTitle="Architectural Window Film" bgUrl="/image/product/building-banner.webp" />
      <ProductIntro 
        ...
        imgUrl="/image/product/building-hero.webp" 
      />
      <ProductSpecs columns={columnsData} rows={specsRows} />
      <ProductGallery images={['/image/product/building-g1.webp']} faqs={[]} />
    </main>
  );
}